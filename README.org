...
object creation could result in design problems or in added complexity
to the design. Creational design patterns solve this problem by
somehow controlling this object creation.

There are many different creational design patterns, each with its own
specific purpose. Some of the most common creational design patterns
include:

** Factory Method
The factory method pattern defines an interface for creating objects,
but lets sub-classes decide which class to instantiate. This pattern is
often used when there are many different types of objects that can be
created, and the client code doesn't need to know which type of object
to create.

** Abstract Factory
The abstract factory pattern is similar to the factory method pattern,
but it allows for the creation of families of related objects. This
pattern is often used when there are many different types of objects
that are related to each other, such as different types of animals or
different types of vehicles.

** Builder
The builder pattern is used to construct complex objects step by step.
This pattern is often used when the object to be constructed is large
or complex, and the client code doesn't need to know the details of
how the object is constructed.

** Singleton
The singleton pattern ensures that a class has only one instance. This
pattern is often used when there is a global object that needs to be
accessed from multiple places in the code.

** Prototype
The prototype pattern creates a new object by copying an existing
object. This pattern is often used when the object to be created is
large or complex, and it would be expensive to create it from scratch.

Creational design patterns can be used to make code more modular,
reusable, and flexible. They can also help to improve the readability
and maintainability of code.


* Structural Pattern
A structural design pattern is a design pattern that eases the design
by identifying a simple way to realize relationships among entities.

Structural patterns focus on how classes and objects can be composed,
to form larger structures. Structural design patterns simplifies the
structure by identifying the relationships. These patterns focus on,
how the classes inherit from each other and how they are composed from
other classes.

Structural design patterns are a powerful tool that can help you to
design more flexible and efficient software. By using structural
patterns, you can avoid code duplication, improve readability and
maintainability, and make your code more reusable.

Here are some of the most common structural design patterns:
** Adapter pattern
Converts the interface of one class into an interface that another
class expects.
